//--------------------------------------------------------------------------------
// Auto-generated by Migen (a5cc037) & LiteX (5097b7ae) on 2022-10-12 09:02:02
//--------------------------------------------------------------------------------
module c4e6e10(
...
wire builder_csrbank3_out0_re;
wire [9:0] builder_csrbank3_out0_r;
wire builder_csrbank3_out0_we;
wire [9:0] builder_csrbank3_out0_w;
...
wire [7:0] builder_csrbank4_in_r;
wire builder_csrbank4_in_we;
wire [7:0] builder_csrbank4_in_w;
...
wire builder_csrbank5_load0_re;
wire [31:0] builder_csrbank5_load0_r;
wire builder_csrbank5_load0_we;
wire [31:0] builder_csrbank5_load0_w;
wire builder_csrbank5_reload0_re;
wire [31:0] builder_csrbank5_reload0_r;
wire builder_csrbank5_reload0_we;
wire [31:0] builder_csrbank5_reload0_w;
wire builder_csrbank5_en0_re;
wire builder_csrbank5_en0_r;
wire builder_csrbank5_en0_we;
wire builder_csrbank5_en0_w;
wire builder_csrbank5_update_value0_re;
wire builder_csrbank5_update_value0_r;
wire builder_csrbank5_update_value0_we;
wire builder_csrbank5_update_value0_w;
wire builder_csrbank5_value_re;
wire [31:0] builder_csrbank5_value_r;
wire builder_csrbank5_value_we;
wire [31:0] builder_csrbank5_value_w;
wire builder_csrbank5_ev_enable0_re;
wire builder_csrbank5_ev_enable0_r;
wire builder_csrbank5_ev_enable0_we;
wire builder_csrbank5_ev_enable0_w;
...
wire builder_csrbank6_txfull_re;
wire builder_csrbank6_txfull_r;
wire builder_csrbank6_txfull_we;
wire builder_csrbank6_txfull_w;
wire builder_csrbank6_rxempty_re;
wire builder_csrbank6_rxempty_r;
wire builder_csrbank6_rxempty_we;
wire builder_csrbank6_rxempty_w;
wire builder_csrbank6_ev_enable0_re;
wire [1:0] builder_csrbank6_ev_enable0_r;
wire builder_csrbank6_ev_enable0_we;
wire [1:0] builder_csrbank6_ev_enable0_w;
wire builder_csrbank6_txempty_re;
wire builder_csrbank6_txempty_r;
wire builder_csrbank6_txempty_we;
wire builder_csrbank6_txempty_w;
wire builder_csrbank6_rxfull_re;
wire builder_csrbank6_rxfull_r;
wire builder_csrbank6_rxfull_we;
wire builder_csrbank6_rxfull_w;
...
wire builder_csrbank7_tuning_word0_re;
wire [31:0] builder_csrbank7_tuning_word0_r;
wire builder_csrbank7_tuning_word0_we;
wire [31:0] builder_csrbank7_tuning_word0_w;
...
(* no_retiming = "true" *) reg builder_multiregimpl0_regs0 = 1'd0;
(* no_retiming = "true" *) reg builder_multiregimpl0_regs1 = 1'd0;
(* no_retiming = "true" *) reg [7:0] builder_multiregimpl1_regs0 = 8'd0;
(* no_retiming = "true" *) reg [7:0] builder_multiregimpl1_regs1 = 8'd0;
(* no_retiming = "true" *) reg [2:0] builder_multiregimpl2_regs0 = 3'd0;
(* no_retiming = "true" *) reg [2:0] builder_multiregimpl2_regs1 = 3'd0;
...
assign builder_csrbank0_sel = (builder_interface0_bank_bus_adr[13:10] == 3'd7);
...
assign builder_csrbank1_sel = (builder_interface1_bank_bus_adr[13:10] == 1'd0);
...
assign builder_csrbank2_sel = (builder_interface2_bank_bus_adr[13:10] == 4'd8);
...
assign builder_csrbank3_out0_r = builder_interface3_bank_bus_dat_w[9:0];
assign builder_csrbank3_out0_re = ((builder_csrbank3_sel & builder_interface3_bank_bus_we) & (builder_interface3_bank_bus_adr[0] == 1'd0));
assign builder_csrbank3_out0_we = ((builder_csrbank3_sel & (~builder_interface3_bank_bus_we)) & (builder_interface3_bank_bus_adr[0] == 1'd0));
assign builder_csrbank3_out0_w = basesoc_leds_storage[9:0];
assign builder_csrbank4_sel = (builder_interface4_bank_bus_adr[13:10] == 3'd6);
assign builder_csrbank4_in_r = builder_interface4_bank_bus_dat_w[7:0];
...
assign builder_csrbank4_in_w = basesoc_switchs_status[7:0];
assign basesoc_switchs_we = builder_csrbank4_in_we;
assign basesoc_switchs_re = builder_csrbank4_in_re;
assign builder_csrbank5_sel = (builder_interface5_bank_bus_adr[13:10] == 3'd4);
assign builder_csrbank5_load0_r = builder_interface5_bank_bus_dat_w[31:0];
assign builder_csrbank5_load0_re = ((builder_csrbank5_sel & builder_interface5_bank_bus_we) & (builder_interface5_bank_bus_adr[2:0] == 1'd0));
assign builder_csrbank5_load0_we = ((builder_csrbank5_sel & (~builder_interface5_bank_bus_we)) & (builder_interface5_bank_bus_adr[2:0] == 1'd0));
assign builder_csrbank5_reload0_r = builder_interface5_bank_bus_dat_w[31:0];
assign builder_csrbank5_reload0_re = ((builder_csrbank5_sel & builder_interface5_bank_bus_we) & (builder_interface5_bank_bus_adr[2:0] == 1'd1));
assign builder_csrbank5_reload0_we = ((builder_csrbank5_sel & (~builder_interface5_bank_bus_we)) & (builder_interface5_bank_bus_adr[2:0] == 1'd1));
assign builder_csrbank5_en0_r = builder_interface5_bank_bus_dat_w[0];
assign builder_csrbank5_en0_re = ((builder_csrbank5_sel & builder_interface5_bank_bus_we) & (builder_interface5_bank_bus_adr[2:0] == 2'd2));
assign builder_csrbank5_en0_we = ((builder_csrbank5_sel & (~builder_interface5_bank_bus_we)) & (builder_interface5_bank_bus_adr[2:0] == 2'd2));
assign builder_csrbank5_update_value0_r = builder_interface5_bank_bus_dat_w[0];
assign builder_csrbank5_update_value0_re = ((builder_csrbank5_sel & builder_interface5_bank_bus_we) & (builder_interface5_bank_bus_adr[2:0] == 2'd3));
assign builder_csrbank5_update_value0_we = ((builder_csrbank5_sel & (~builder_interface5_bank_bus_we)) & (builder_interface5_bank_bus_adr[2:0] == 2'd3));
assign builder_csrbank5_value_r = builder_interface5_bank_bus_dat_w[31:0];
assign builder_csrbank5_value_re = ((builder_csrbank5_sel & builder_interface5_bank_bus_we) & (builder_interface5_bank_bus_adr[2:0] == 3'd4));
assign builder_csrbank5_value_we = ((builder_csrbank5_sel & (~builder_interface5_bank_bus_we)) & (builder_interface5_bank_bus_adr[2:0] == 3'd4));
assign basesoc_basesoc_timer_eventmanager_status_r = builder_interface5_bank_bus_dat_w[0];
assign basesoc_basesoc_timer_eventmanager_status_re = ((builder_csrbank5_sel & builder_interface5_bank_bus_we) & (builder_interface5_bank_bus_adr[2:0] == 3'd5));
assign basesoc_basesoc_timer_eventmanager_status_we = ((builder_csrbank5_sel & (~builder_interface5_bank_bus_we)) & (builder_interface5_bank_bus_adr[2:0] == 3'd5));
assign basesoc_basesoc_timer_eventmanager_pending_r = builder_interface5_bank_bus_dat_w[0];
assign basesoc_basesoc_timer_eventmanager_pending_re = ((builder_csrbank5_sel & builder_interface5_bank_bus_we) & (builder_interface5_bank_bus_adr[2:0] == 3'd6));
assign basesoc_basesoc_timer_eventmanager_pending_we = ((builder_csrbank5_sel & (~builder_interface5_bank_bus_we)) & (builder_interface5_bank_bus_adr[2:0] == 3'd6));
assign builder_csrbank5_ev_enable0_r = builder_interface5_bank_bus_dat_w[0];
assign builder_csrbank5_ev_enable0_re = ((builder_csrbank5_sel & builder_interface5_bank_bus_we) & (builder_interface5_bank_bus_adr[2:0] == 3'd7));
assign builder_csrbank5_ev_enable0_we = ((builder_csrbank5_sel & (~builder_interface5_bank_bus_we)) & (builder_interface5_bank_bus_adr[2:0] == 3'd7));
assign builder_csrbank5_load0_w = basesoc_basesoc_timer_load_storage[31:0];
assign builder_csrbank5_reload0_w = basesoc_basesoc_timer_reload_storage[31:0];
assign builder_csrbank5_en0_w = basesoc_basesoc_timer_en_storage;
assign builder_csrbank5_update_value0_w = basesoc_basesoc_timer_update_value_storage;
assign builder_csrbank5_value_w = basesoc_basesoc_timer_value_status[31:0];
assign basesoc_basesoc_timer_value_we = builder_csrbank5_value_we;
assign basesoc_basesoc_timer_value_re = builder_csrbank5_value_re;
assign builder_csrbank5_ev_enable0_w = basesoc_basesoc_timer_eventmanager_storage;
assign builder_csrbank6_sel = (builder_interface6_bank_bus_adr[13:10] == 2'd3);
assign basesoc_basesoc_uart_rxtx_r = builder_interface6_bank_bus_dat_w[7:0];
assign basesoc_basesoc_uart_rxtx_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[2:0] == 1'd0));
assign basesoc_basesoc_uart_rxtx_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[2:0] == 1'd0));
assign builder_csrbank6_txfull_r = builder_interface6_bank_bus_dat_w[0];
assign builder_csrbank6_txfull_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[2:0] == 1'd1));
assign builder_csrbank6_txfull_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[2:0] == 1'd1));
assign builder_csrbank6_rxempty_r = builder_interface6_bank_bus_dat_w[0];
assign builder_csrbank6_rxempty_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[2:0] == 2'd2));
assign builder_csrbank6_rxempty_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[2:0] == 2'd2));
assign basesoc_basesoc_uart_eventmanager_status_r = builder_interface6_bank_bus_dat_w[1:0];
assign basesoc_basesoc_uart_eventmanager_status_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[2:0] == 2'd3));
assign basesoc_basesoc_uart_eventmanager_status_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[2:0] == 2'd3));
assign basesoc_basesoc_uart_eventmanager_pending_r = builder_interface6_bank_bus_dat_w[1:0];
assign basesoc_basesoc_uart_eventmanager_pending_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[2:0] == 3'd4));
assign basesoc_basesoc_uart_eventmanager_pending_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[2:0] == 3'd4));
assign builder_csrbank6_ev_enable0_r = builder_interface6_bank_bus_dat_w[1:0];
assign builder_csrbank6_ev_enable0_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[2:0] == 3'd5));
assign builder_csrbank6_ev_enable0_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[2:0] == 3'd5));
assign builder_csrbank6_txempty_r = builder_interface6_bank_bus_dat_w[0];
assign builder_csrbank6_txempty_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[2:0] == 3'd6));
assign builder_csrbank6_txempty_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[2:0] == 3'd6));
assign builder_csrbank6_rxfull_r = builder_interface6_bank_bus_dat_w[0];
assign builder_csrbank6_rxfull_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[2:0] == 3'd7));
assign builder_csrbank6_rxfull_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[2:0] == 3'd7));
assign builder_csrbank6_txfull_w = basesoc_basesoc_uart_txfull_status;
assign basesoc_basesoc_uart_txfull_we = builder_csrbank6_txfull_we;
assign basesoc_basesoc_uart_txfull_re = builder_csrbank6_txfull_re;
assign builder_csrbank6_rxempty_w = basesoc_basesoc_uart_rxempty_status;
assign basesoc_basesoc_uart_rxempty_we = builder_csrbank6_rxempty_we;
assign basesoc_basesoc_uart_rxempty_re = builder_csrbank6_rxempty_re;
assign builder_csrbank6_ev_enable0_w = basesoc_basesoc_uart_eventmanager_storage[1:0];
assign builder_csrbank6_txempty_w = basesoc_basesoc_uart_txempty_status;
assign basesoc_basesoc_uart_txempty_we = builder_csrbank6_txempty_we;
assign basesoc_basesoc_uart_txempty_re = builder_csrbank6_txempty_re;
assign builder_csrbank6_rxfull_w = basesoc_basesoc_uart_rxfull_status;
assign basesoc_basesoc_uart_rxfull_we = builder_csrbank6_rxfull_we;
assign basesoc_basesoc_uart_rxfull_re = builder_csrbank6_rxfull_re;
assign builder_csrbank7_sel = (builder_interface7_bank_bus_adr[13:10] == 2'd2);
assign builder_csrbank7_tuning_word0_r = builder_interface7_bank_bus_dat_w[31:0];
assign builder_csrbank7_tuning_word0_re = ((builder_csrbank7_sel & builder_interface7_bank_bus_we) & (builder_interface7_bank_bus_adr[0] == 1'd0));
assign builder_csrbank7_tuning_word0_we = ((builder_csrbank7_sel & (~builder_interface7_bank_bus_we)) & (builder_interface7_bank_bus_adr[0] == 1'd0));
assign builder_csrbank7_tuning_word0_w = basesoc_basesoc_storage[31:0];
...
assign basesoc_basesoc_rx = builder_multiregimpl0_regs1;
assign basesoc_switchs_status = builder_multiregimpl1_regs1;
assign basesoc_buttons_status = builder_multiregimpl2_regs1;
...
always @(posedge sys_clk) begin
	...
	if (builder_csrbank3_out0_re) begin
		basesoc_leds_storage[9:0] <= builder_csrbank3_out0_r;
	end
	basesoc_leds_re <= builder_csrbank3_out0_re;
	...
	if (builder_csrbank5_sel) begin
		case (builder_interface5_bank_bus_adr[2:0])
			1'd0: begin
				builder_interface5_bank_bus_dat_r <= builder_csrbank5_load0_w;
			end
			1'd1: begin
				builder_interface5_bank_bus_dat_r <= builder_csrbank5_reload0_w;
			end
			2'd2: begin
				builder_interface5_bank_bus_dat_r <= builder_csrbank5_en0_w;
			end
			2'd3: begin
				builder_interface5_bank_bus_dat_r <= builder_csrbank5_update_value0_w;
			end
			3'd4: begin
				builder_interface5_bank_bus_dat_r <= builder_csrbank5_value_w;
			end
			3'd5: begin
				builder_interface5_bank_bus_dat_r <= basesoc_basesoc_timer_eventmanager_status_w;
			end
			3'd6: begin
				builder_interface5_bank_bus_dat_r <= basesoc_basesoc_timer_eventmanager_pending_w;
			end
			3'd7: begin
	...
	if (builder_csrbank5_load0_re) begin
		basesoc_basesoc_timer_load_storage[31:0] <= builder_csrbank5_load0_r;
	end
	basesoc_basesoc_timer_load_re <= builder_csrbank5_load0_re;
	if (builder_csrbank5_reload0_re) begin
		basesoc_basesoc_timer_reload_storage[31:0] <= builder_csrbank5_reload0_r;
	end
	basesoc_basesoc_timer_reload_re <= builder_csrbank5_reload0_re;
	if (builder_csrbank5_en0_re) begin
		basesoc_basesoc_timer_en_storage <= builder_csrbank5_en0_r;
	end
	basesoc_basesoc_timer_en_re <= builder_csrbank5_en0_re;
	if (builder_csrbank5_update_value0_re) begin
		basesoc_basesoc_timer_update_value_storage <= builder_csrbank5_update_value0_r;
	end
	basesoc_basesoc_timer_update_value_re <= builder_csrbank5_update_value0_re;
	if (builder_csrbank5_ev_enable0_re) begin
		basesoc_basesoc_timer_eventmanager_storage <= builder_csrbank5_ev_enable0_r;
	end
	basesoc_basesoc_timer_eventmanager_re <= builder_csrbank5_ev_enable0_re;
	builder_interface6_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank6_sel) begin
		case (builder_interface6_bank_bus_adr[2:0])
			1'd0: begin
				builder_interface6_bank_bus_dat_r <= basesoc_basesoc_uart_rxtx_w;
			end
			1'd1: begin
				builder_interface6_bank_bus_dat_r <= builder_csrbank6_txfull_w;
			end
			2'd2: begin
				builder_interface6_bank_bus_dat_r <= builder_csrbank6_rxempty_w;
			end
			2'd3: begin
				builder_interface6_bank_bus_dat_r <= basesoc_basesoc_uart_eventmanager_status_w;
			end
			3'd4: begin
				builder_interface6_bank_bus_dat_r <= basesoc_basesoc_uart_eventmanager_pending_w;
			end
			3'd5: begin
				builder_interface6_bank_bus_dat_r <= builder_csrbank6_ev_enable0_w;
			end
			3'd6: begin
				builder_interface6_bank_bus_dat_r <= builder_csrbank6_txempty_w;
			end
			3'd7: begin
				builder_interface6_bank_bus_dat_r <= builder_csrbank6_rxfull_w;
			end
		endcase
	end
	if (builder_csrbank6_ev_enable0_re) begin
		basesoc_basesoc_uart_eventmanager_storage[1:0] <= builder_csrbank6_ev_enable0_r;
	end
	basesoc_basesoc_uart_eventmanager_re <= builder_csrbank6_ev_enable0_re;
	builder_interface7_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank7_sel) begin
		case (builder_interface7_bank_bus_adr[0])
			1'd0: begin
				builder_interface7_bank_bus_dat_r <= builder_csrbank7_tuning_word0_w;
			end
		endcase
	end
	if (builder_csrbank7_tuning_word0_re) begin
		basesoc_basesoc_storage[31:0] <= builder_csrbank7_tuning_word0_r;
	end
	basesoc_basesoc_re <= builder_csrbank7_tuning_word0_re;
	if (sys_rst) begin
	...
	builder_multiregimpl1_regs0 <= {sw7, sw6, sw5, sw4, sw3, sw2, sw1, sw0};
	builder_multiregimpl1_regs1 <= builder_multiregimpl1_regs0;
	builder_multiregimpl2_regs0 <= {btnl, btnr, btnc};
